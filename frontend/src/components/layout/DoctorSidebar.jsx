...
const DoctorSidebar = () => {
    ...
    const menuItems = [
        { name: "My Appointments", path: "/doctor/appointments", icon: <CalendarDays size={18} /> },
        { name: "My Patients", path: "/doctor/patients", icon: <Users size={18} /> },
        { name: "Consultations", path: "/doctor/consultations", icon: <ClipboardList size={18} /> },
    ];
            ...
            <div style={{ padding: '28px 20px 20px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: '0.68rem', fontWeight: 700, color: '#6D2932', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Doctor Portal</div>
                    </div>
                </div>
            </div>
