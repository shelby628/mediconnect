...
import { Search, Calendar, History, ShieldCheck, ArrowRight, CheckCircle2, Star } from 'lucide-react';
...
const FontLoader = () => (
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-badge span { width: 6px; height: 6px; background: var(--primary); border-radius: 50%; display: inline-block; animation: pulse 2s infinite; }
    ...
    .testi-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; max-width: 960px; margin: 0 auto; }
    .testi-card {
    ...
    .testi-card blockquote { font-size: 0.95rem; color: rgba(247,243,236,0.85); line-height: 1.75; margin-bottom: 1.5rem; font-style: italic; }
    .testi-author { display: flex; align-items: center; gap: 12px; }
    .avatar { width: 40px; height: 40px; border-radius: 50%; background: var(--primary-light); display: flex; align-items: center; justify-content: center; font-weight: 700; color: #fff; font-size: 0.9rem; }
    ...
    .cta-banner h2 { font-family: 'Playfair Display', serif; font-size: clamp(1.6rem, 3vw, 2.4rem); font-weight: 900; color: #fff; margin-bottom: 0.5rem; }
        ...
        <>
            ...
            <section className="hero">
                ...
                <div className="hero-content">
                    ...
                    <h1>Modern Care for<br /><em>Modern Patients</em></h1>
                    <p>MediConnect streamlines your entire healthcare journey — from booking appointments to accessing medical records — in one elegant, secure platform.</p>
                    <div className="hero-actions">
                        <Link to="/signup" className="btn-primary">Get Started Free <ArrowRight size={18} /></Link>
                        <a href="#how" className="btn-secondary">See how it works</a>
                    </div>
                    <div className="hero-stats">
                        <div className="stat"><h3>12k+</h3><p>Active Patients</p></div>
                        <div className="stat"><h3>98%</h3><p>Satisfaction Rate</p></div>
                        <div className="stat"><h3>50+</h3><p>Departments</p></div>
                    </div>
                </div>
                <HeroVisual />
            </section>
            ...
            <section className="features" id="features">
                ...
                <div className="features-grid">
                    {[
                        { title: 'Doctor Availability', desc: 'Real-time status of doctors across all hospital departments — no more guessing or waiting in queues.' },
                        { title: 'Smart Booking', desc: 'Secure your appointment instantly with our  zero-friction booking system.' },
                        { title: 'Consultation History', desc: 'Keep a private, digital record of every visit, prescription, and medical note.' },
                        { title: 'Secure Medical Records', desc: 'Your data is encrypted and protected with industry-leading, HIPAA-aligned security standards.' },
                    ].map((f, i) => (
            ...
            <section className="testimonials" id="reviews">
                ...
                <p className="section-sub">Real experiences from real patients across our network.</p>
                <div className="testi-grid">
                    {[
                        { q: 'Booking an appointment used to take hours on the phone. MediConnect cut it down to 30 seconds. Genuinely life-changing.', name: 'Amina K.', role: 'Patient · Nairobi', init: 'AK' },
                        { q: 'Having all my consultation history in one secure place is incredible. I no longer carry folders of paper records to every visit.', name: 'Brian O.', role: 'Patient · Mombasa', init: 'BO' },
                        { q: 'The real-time doctor availability feature is exactly what hospitals have been missing. Clean, fast, and incredibly intuitive.', name: 'Dr. Sara M.', role: 'Physician · Kisumu', init: 'SM' },
                    ].map((t, i) => (
                        <div className="testi-card" key={i}>
                            <div className="stars">{[...Array(5)].map((_, j) => <Star key={j} size={15} fill="currentColor" />)}</div>
            ...
            <div className="cta-banner">
                <div>
                    ...
                    <p>Join 12,000+ patients already using MediConnect.</p>
                </div>
